...
// We can read criteria and questions from the compiled or typescript file
// Let's create the sync function
async function syncNeon() {
  ...
  try {
    ...
    // Create table if not exists or ensure schema
    await client.query(`
    ...
    await client.query(`
      ...
      ALTER TABLE questions ADD COLUMN IF NOT EXISTS guide_image TEXT;
      ALTER TABLE questions ADD COLUMN IF NOT EXISTS help_guidance TEXT;
    `);

    // Clean old criteria and questions
    await client.query('DELETE FROM questions;');
    await client.query('DELETE FROM criteria;');

    // Load criteria definition
    const criteria = [
      {
    ...
    console.log('Inserted 7 criteria into Neon DB.');

    // Questions
    const questions = [
      {
        id: 'q-lane-count',
        criterion_id: 'crit-road-geometry',
        code: 'SR4S-01',
        ...
        help_guidance: 'Rasmiy SR4S standarti bo‘yicha 4 xil toifada baholanadi.',
        guide_image: '/sr4s-guide/image2.png',
        options: [
      ...
      },
      {
        ...
        points: 4,
        requires_evidence: true,
        help_guidance: 'Standart oraliqlar: 0% < t < 7.5%, 7.5% ≤ t < 10%, t ≥ 10%.',
        guide_image: '/sr4s-guide/image4.png',
        options: [
      ...
      },
      {
        ...
        points: 4,
        requires_evidence: true,
        help_guidance: 'Metall/beton to‘siqlar yoki xavfsizlik orolchalari o‘quvchilar xavfsizligini ta’minlaydi.',
        guide_image: '/sr4s-guide/image6.png',
        options: [
      ...
      },
      {
        ...
        guide_image: '/sr4s-guide/image14.png',
        options: [
      ...
      },
      {
        ...
        criterion_id: 'crit-school-signs',
        code: 'SR4S-05',
        ...
        points: 6,
        requires_evidence: true,
        help_guidance: 'Rasmiy standartda 4 ta asosiy variant mavjud.',
        guide_image: '/sr4s-guide/image8.png',
        options: [
      ...
      },
      {
        ...
        points: 5,
        requires_evidence: true,
        help_guidance: 'Rasmiy standartda 3 ta variant mavjud.',
        guide_image: '/sr4s-guide/image10.png',
        options: [
      ...
      },
      {
        ...
        points: 4,
        requires_evidence: true,
        guide_image: '/sr4s-guide/image31.png',
        options: [
      ...
      {
        id: 'q-sidewalk-left',
        criterion_id: 'crit-pedestrian-sidewalks',
        code: 'SR4S-08',
        ...
        points: 5,
        requires_evidence: true,
        guide_image: '/sr4s-guide/image12.png',
        options: [
      ...
      },
      {
        ...
        points: 4,
        requires_evidence: true,
        guide_image: '/sr4s-guide/image18.png',
        options: [
      ...
      },
      {
        ...
        points: 5,
        requires_evidence: false,
        guide_image: '/sr4s-guide/image20.png',
        options: [
      ...
      },
      {
        ...
        points: 4,
        requires_evidence: false,
        guide_image: '/sr4s-guide/image24.png',
        options: [
      ...
      },
      {
        ...
        points: 4,
        requires_evidence: false,
        guide_image: '/sr4s-guide/image27.png',
        options: [
      ...
      },
      {
        ...
        points: 3,
        requires_evidence: false,
        guide_image: '/sr4s-guide/image29.png',
        options: [
      ...
      },
      {
        ...
        criterion_id: 'crit-speeds-traffic',
        code: 'SR4S-18',
        ...
        points: 4,
        requires_evidence: false,
        guide_image: '/sr4s-guide/image33.png',
        options: [
      ...
      },
      {
        ...
        points: 4,
        requires_evidence: false,
        guide_image: '/sr4s-guide/image39.png',
        options: [
      ...
      },
      {
        ...
        points: 4,
        requires_evidence: false,
        guide_image: '/sr4s-guide/image37.png',
        options: [
      ...
      },
      {
        ...
        points: 3,
        requires_evidence: false,
        guide_image: '/sr4s-guide/image35.png',
        options: [
      ...
      },
      {
        ...
        criterion_id: 'crit-land-environment',
        code: 'SR4S-22',
    ...
    for (const q of questions) {
      await client.query(
        `INSERT INTO questions (id, criterion_id, text, description, points, requires_evidence, options, code, guide_image, help_guidance)
    ...
    console.log('Inserted 23 questions into Neon DB.');

    await client.query('COMMIT');
    console.log('Neon Database Criteria & Questions successfully synchronized 1-to-1!');
  } catch (err) {
    await client.query('ROLLBACK');
    console.error('Failed to sync Neon database:', err);
  } finally {
    client.release();
    await pool.end();
  }
